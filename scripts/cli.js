...
const contractABI = require("../artifacts/contracts/Fullstackethereum.sol/Fullstackethereum.json").abi;

program
    .name("fullstackethereum-cli")
    .description("CLI tool for Fullstackethereum smart contract")
    .version("1.0.0");
